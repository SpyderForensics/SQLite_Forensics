...
def parse_sqlite_header(file):
    ...
    if len(header) < 100:
        raise ValueError("[-] Error: File too small to be a valid SQLite database.")
    ...
    return {"page_size": page_size, "auto_vacuum": auto_vacuum, "first_freelist_trunk_page":first_freelist_trunk_page}
